...
<body>
    <div class="container">
        ...
        <div class="card">
            <h3>Quick Actions</h3>
            <a href="{{ route('fund.wallet') }}" class="btn btn-fund">💰 Fund Wallet</a>
        ...
        <div class="card">
            ...
            @empty
                <p style="text-align: center; color: #666;">No transactions yet. Start by funding your wallet!</p>
            @endforelse
        </div>
